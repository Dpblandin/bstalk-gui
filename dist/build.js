...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stickyRefresh = __webpack_require__(107);
	...
	new _vue2.default({
	    ...
	    ready: function ready() {
	        ...
	        _electron.ipcRenderer.on('toggle-view', function (event, arg) {
	            _this.toggledView = arg;
	        });
	    },
	                ...
	                try {
	                    var _loop = function _loop() {
	                        ...
	                        promises.push(new _promise2.default(function (resolve, reject) {
	                            _api2.default.getEnvironments(repo.name, function (err, envs) {
	                                if (err) {
	                                    _this3.reportError(err);
	                                    _this3.isLoading = false;
	    ...
	    events: {
	        ...
	        'deploy-repo': function deployRepo(repo) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _environment = __webpack_require__(73);
	...
	// <script>
	exports.default = {
	    components: { Environment: _environment2.default },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _confirmModal = __webpack_require__(82);
	...
	exports.default = {
	    ...
	    events: {
	        'deploy-repo': function deployRepo(repoEnv) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./confirmModal.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./confirmModal.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    methods: {
	        sendDeployEvent: function sendDeployEvent(repo, envId) {
	            this.$dispatch('deploy-repo', { repoId: repo.id, envId: envId });
	        }
	    },
